	...
	public TargetControlPanel() {
        ...
        addButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (DomainPanel.getDomainResult() == null) {
                    ...
                    DomainPanel.getDomainTableModel().addRow(entry.getTarget(),entry);
        ...
        removeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                TargetTableModel domainTableModel = DomainPanel.getDomainTableModel();
        ...
        btnFresh.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                GUI.GUI.domainPanel.showToDomainUI();
                DomainPanel.autoSave();
            }
        });
